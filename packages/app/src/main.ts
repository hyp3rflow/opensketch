...
import { setupLivePreview } from "./ui/live-preview";
import { setupComponentExport } from "./ui/component-export";
import { setupComponentExport } from "./ui/component-export";
...
async function main() {
  ...
  setupLivePreview(document.getElementById("live-preview-panel")!, editor);
  setupComponentExport(document.getElementById("component-export-panel")!, editor);
  setupComponentExport(document.getElementById("component-export-panel")!, editor);
