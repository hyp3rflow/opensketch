...
export const icons = {
  ...
  lockOpen: s('<rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 9.9-1"/>'),
  ...
  shapeBuilder: s('<rect x="3" y="5" width="8" height="8" rx="1"/><rect x="9" y="11" width="8" height="8" rx="1"/><path d="M2 18c3-1 5-4 8-4 3 0 4 2 6 2 2 0 3-1 6-4"/>'),
  // Component (diamond)
  component: s('<path d="M12 2l10 10-10 10L2 12z"/>'),
  componentSet: s('<path d="M7 2l5 5-5 5L2 7z"/><path d="M17 2l5 5-5 5-5-5z"/><path d="M7 12l5 5-5 5-5-5z"/><path d="M17 12l5 5-5 5-5-5z"/>'),
  ...
  callout: s('<rect x="2" y="2" width="18" height="13" rx="3" fill="none"/><polygon points="8,15 12,21 14,15" fill="none"/>'),
  ...
  scale: s('<rect x="2" y="2" width="8" height="8" rx="1" opacity="0.4"/><rect x="8" y="8" width="14" height="14" rx="1"/><path d="M18 12v-2h2v4h-4v-2h2z" fill="currentColor" stroke="none"/><path d="M12 18h-2v2h4v-4h-2v2z" fill="currentColor" stroke="none"/>'),
  eyedropper: s('<path d="M20.71 2.29a1 1 0 0 0-1.42 0l-2.12 2.12-1.41-1.41-1.42 1.42 1.41 1.41L4.29 17.29a1 1 0 0 0-.26.47l-1 4a1 1 0 0 0 1.21 1.21l4-1a1 1 0 0 0 .47-.26L20.17 10.25l1.41 1.41 1.42-1.42-1.41-1.41 2.12-2.12a1 1 0 0 0 0-1.42z"/>'),
  measureTool: s('<path d="M3 21L21 3" stroke-dasharray="4 3"/><circle cx="3" cy="21" r="2" fill="currentColor" stroke="none"/><circle cx="21" cy="3" r="2" fill="currentColor" stroke="none"/><rect x="8" y="8" width="8" height="5" rx="2" fill="none"/><text x="12" y="12" font-size="5" text-anchor="middle" fill="currentColor" stroke="none" font-weight="bold">px</text>'),
  ...
  chart: s('<rect x="3" y="3" width="18" height="18" rx="2" fill="none"/><rect x="5" y="12" width="3" height="7" rx="0.5"/><rect x="10" y="8" width="3" height="11" rx="0.5"/><rect x="15" y="5" width="3" height="14" rx="0.5"/>'),
