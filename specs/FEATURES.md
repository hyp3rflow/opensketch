...
- [x] Selection (single + multi-select + marquee drag-select, with resize handles). **Multi-Object Transform Box (2026-04-11)**: multi-selection 시 공통 bounding box 핸들을 렌더링하고 corner scale/flip, rotation handle, draggable pivot(회전·스케일 기준점 이동)를 지원.
